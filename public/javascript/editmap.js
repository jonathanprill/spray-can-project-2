...
// var mapPinEl = document.querySelector('.map-pin').textContent;


// console.log(mapPinEl);


pinArr.forEach((mapPinEl) => {
    L.marker(mapPinEl).addTo(map).bindPopup('<img src="/uploads/streetart4.jpg" alt="Placeholder image">')
